...
import { ScaleLoader, BarLoader, CircleLoader, PropagateLoader, MoonLoader, SyncLoader } from 'react-spinners';
import styled from 'styled-components';

interface LoaderProps {
  type?: 'scale' | 'bar' | 'circle' | 'propogate' | 'moon' | 'sync';
  [key: string]: any;
}
...
const Loader: React.FC<LoaderProps> = ({ type = 'scale', ...rest }) => {
  ...
  switch (type) {
    ...
    case 'propogate':
      ...
      break;
    case 'moon':
      LoaderComponent = MoonLoader;
      break;
    case 'sync':
      LoaderComponent = SyncLoader;
      break;
    default:
